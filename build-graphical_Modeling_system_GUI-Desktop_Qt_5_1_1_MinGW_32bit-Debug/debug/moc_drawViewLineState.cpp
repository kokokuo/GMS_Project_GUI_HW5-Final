/****************************************************************************
** Meta object code from reading C++ file 'drawViewLineState.h'
**
...
#include "../../graphical_Modeling_system_GUI/drawViewLineState.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'drawViewLineState.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_DrawViewLineState_t {
    QByteArrayData data[3];
    char stringdata[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DrawViewLineState_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_DrawViewLineState_t qt_meta_stringdata_DrawViewLineState = {
    {
QT_MOC_LITERAL(0, 0, 17),
QT_MOC_LITERAL(1, 18, 21),
QT_MOC_LITERAL(2, 40, 0)
    },
    "DrawViewLineState\0SendGetDrawLinePoints\0"
    "\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_DrawViewLineState[] = {
...
const QMetaObject DrawViewLineState::staticMetaObject = {
    { &DrawViewState::staticMetaObject, qt_meta_stringdata_DrawViewLineState.data,
      qt_meta_data_DrawViewLineState,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DrawViewLineState.stringdata))
